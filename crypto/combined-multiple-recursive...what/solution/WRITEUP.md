...
This challenge involve's attacking the linearity of a CMRG (Combined Multiple Recursive Generator). You can find the original attack paper in section 5 of [this](https://eprint.iacr.org/2021/1204.pdf) paper. I'd like to note as I don't want to take credit for someone else's work, the source code for this challenge was almost exactly (multiple parameters modified slightly to make it slightly easier and obviously the flag) taken from an older challenge from a CTF a few years ago. The writeup's available are all foreign langauges I don't understand and I'm too lazy to translate via google (especially considering copying over the LaTex, which can get goofy) so I did write the solution myself at least and did not just copy and paste someone else's code, that's honest... that would completely defeat the original purpose of creating/releasing this challenge in the first place as it was a learning experience for me as well! While sadly this challenge didn't get any solves throughout the hackathon,  below is the explaination as to the solution of this challenge + solution code:
